...
import { eliminarProductos } from "../data/productos";
...
const CarritoCompra = () => {
    const { productos, eliminarProducto, modificarProductos } = useProductContext();
                                    ...
                                    <li key={prod.id} className="flex items-center gap-4 border-b pb-2 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2 mt-2">
                                                {/*Añadir un elemento de interaccion del boton y mostrar la cantidad que se incrementa o baja*/}
                                                {/*<p>{prod.cantidad}</p>*/}
